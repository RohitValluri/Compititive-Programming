...
# where each column represents a quiz, and each row represents a student, and each value represents 
# that student's score on that quiz (except -1 indicates the student did not take the quiz). For example:
#   a = [ [ 88,  80, 91 ],
#         [ 68, 100, -1 ]
#       ]
...
# The function returns the quiz with the highest average. 
# In this case, quiz0 average is 78, quiz1 average is 90, and quiz2 average is 91 (since we ignore the -1). 
...
#           [ 68, 100, 100 ]]))
# print(bestQuiz([ [-1, -1, -1 ],
#           [-1, -1, -1 ]]))
# print(bestQuiz([ [88, -1, -1 ],
#           [68, -1, -1 ]]))                        
def testBestQuiz():
